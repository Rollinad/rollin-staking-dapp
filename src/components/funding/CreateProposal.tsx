...
export const CreateProposal = () => {
  ...
  const { createProposal, isPending, isConfirming, isConfirmed, writeError } =
    useProposalManagement();
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.tokenSupply.trim()) {
      ...
      isNaN(Number(formData.tokenSupply)) ||
      Number(formData.tokenSupply) <= 0
    ) {
  ...
  return (
    ...
    >
      ...
      >
        Create a funding proposal for your project. Once approved, contributors
        can fund your proposal and receive project tokens in return.
      </Typography>
        ...
        <Grid container spacing={3}>
              ...
              InputProps={{
                endAdornment: (
                  <InputAdornment position='end' sx={{ color: "white" }}>
                    ...
                    <Tooltip
                      title={`The amount of ${chain?.nativeCurrency.symbol} you want to raise for your project`}
                    >
                      <IconButton
                        sx={{
          ...
          <Grid item xs={12} md={6}>
            <TextField
              ...
              helperText={
                errors.tokenSupply || "Total number of tokens to be created"
              }
              disabled={isPending || isConfirming}
              InputProps={{
                endAdornment: (
          ...
          <Grid item xs={12}>
            <FormHelperText sx={{ color: "rgba(255, 255, 255, 0.7)", mb: 2 }}>
              Once your proposal is created, it will need to be approved by the
              DAO admin before it can receive funding. After approval, your
              proposal will be visible to potential contributors.
            </FormHelperText>
          </Grid>
